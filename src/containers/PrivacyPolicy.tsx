...
interface ContainerPrivacyPolicyIProps {
  layoutChange: () => UnionedAction;
  titleChange: (title: string) => UnionedAction;
}

const ContainerPrivacyPolicy: React.FC<ContainerPrivacyPolicyIProps> = ({
  layoutChange,
  titleChange
}) => {
  React.useEffect(() => {
  ...
  React.useEffect(() => {
    titleChange("プラバシーポリシー");
  }, [titleChange]);

  const explanation =
    "Funfiction（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。";

  const terms: IKeys[] = [
    {
      article: "第1条（プライバシー情報）",
      paragraph1:
    ...
    {
      article: "第３条（個人情報を収集・利用する目的）",
      paragraph1: "当社が個人情報を収集・利用する目的は，以下のとおりです。",
      paragraph2:
      ...
      paragraph9: "8.上記の利用目的に付随する目的"
    },
    {
      article: "第４条（個人情報の第三者提供）",
      paragraph1:
        "当社は，次に掲げる場合を除いて，あらかじめユーザーの同意を得ることなく，第三者に個人情報を提供することはありません。ただし，個人情報保護法その他の法令で認められる場合を除きます。",
      paragraph2: "1.法令に基づく場合",
      paragraph3:
      ...
      paragraph6: "5.予め次の事項を告知あるいは公表をしている場合",
      paragraph7: "・利用目的に第三者への提供を含むこと",
      paragraph8: "・第三者に提供されるデータの項目",
      paragraph9: "・第三者への提供の手段または方法",
      paragraph10:
        "・本人の求めに応じて個人情報の第三者への提供を停止すること前項の定めにかかわらず，次に掲げる場合は第三者には該当しないものとします。",
      paragraph11:
...
export default connect(null, mapDispatchToProps)(ContainerPrivacyPolicy);
